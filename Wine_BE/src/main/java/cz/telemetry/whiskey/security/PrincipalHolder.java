package cz.telemetry.whiskey.security;
...
/**
 * Implementation of this class provides basic operation related to {@link Authentication} class such as membership and
 * role checking.
 */
public interface PrincipalHolder {
   ...
   *
   * @return specific implementation of {@link Authentication} based on Spring Security authorization flow.
   */
  ...
  /**
   * Method returns {@link Jwt} representation of current principal, from which all claims and fields can be accessed if
   * necessary.
   *
