package cz.telemetry.whiskey.annotation;

import cz.telemetry.whiskey.exception.EntityNotFoundException;
import cz.telemetry.whiskey.exception.error.ConstraintError;
import cz.telemetry.whiskey.exception.error.ErrorResponse;
...
/**
 * Aggregated annotation to fill default error response bodies for each method annotated with this annotation
 */
