...
/**
 * Configuration class for Swagger documentation settings. This class defines configurations for generating Swagger
...
public class SwaggerConfig {
  ...
  /**
   * Creates a {@link BuildProperties} bean when no custom bean is provided. This bean provides build-related
   * properties, such as artifact name and version.
   *
